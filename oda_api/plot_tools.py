...
class OdaImage(OdaProduct):
    ...
    <html>                                                                                                                                                                                     
                <head>                                                                                                                                                                         
                  ...
                  <link type="text/css" rel="stylesheet" href="sites/all/libraries/js9/js9support.css">                                                                                                            
                  <link type="text/css" rel="stylesheet" href="sites/all/libraries/js9/js9.css">                                                                                                                   
                  <script type="text/javascript" src="sites/all/libraries/js9/js9prefs.js"></script>                                                                                                               
                  <script type="text/javascript" src="sites/all/libraries/js9/js9support.min.js"></script>                                                                                                         
                  <script type="text/javascript" src="sites/all/libraries/js9/js9.min.js"></script>                                                                                                                
                  <script type="text/javascript" src="sites/all/libraries/js9/js9plugins.js"></script>                                                                                                             
                    </head>                                                                                                                                                                    
                <body>                                                                                                                                                                         
