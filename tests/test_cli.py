...
def test_get(dispatcher_live_fixture, caplog):
    ...
    assert "found instruments: ['empty', 'empty-async', 'empty-semi-async', 'empty-development']" in caplog.text or \
           "found instruments: ['empty', 'empty-async', 'empty-semi-async', 'empty-development', 'isgri', 'jemx', 'osa_fake']" in caplog.text
